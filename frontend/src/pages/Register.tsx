    ...
    <main className="flex flex-col justify-center items-center h-screen p-8">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-4 w-full max-w-[350px]">
          ...
          <Button type="submit" className="mt-4 p-6 cursor-pointer font-inter-medium">Sign up</Button>  
        </form>
      </Form>
        
      <Link to={"/login"} className="text-center">
        <Button className="p-6 cursor-pointer font-inter-regular" variant={"link"}>I already have an account</Button>  
      </Link>
    </main>
  )
}