import { Loader2, CheckCircle2, Clock, Flame } from "lucide-react";
...
interface SuggestWordFormProps {
  mode: "inline" | "dialog";
  /** Called after the dialog should close (only relevant for dialog mode) */
  onReset?: () => void;
}

export default function SuggestWordForm({ mode, onReset }: SuggestWordFormProps) {
  ...
  // Fetch today's usage count on mount
  useEffect(() => {
